...
Original file is located at
    https://colab.research.google.com/drive/1cghjMLYUPipM0n7Qq1PJM1-Zrub9gbzy
...
for i in range(len(X_test)):
      ...
      actualID = next((k for k, v in diseases_list.items() if v == actual_dis), None)
      if predictedID == actualID: #Compare the predicted id with the actual id.
